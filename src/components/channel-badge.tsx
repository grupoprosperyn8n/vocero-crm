...
// 020: marca oficial de Telegram (simple-icons, CC0).
const TELEGRAM_PATH =
...
const MARK: Record<Channel, { path: string; tile: string }> = {
  ...
  // 020: el avioncito de papel de Telegram; azul celeste de la marca.
  telegram: { path: TELEGRAM_PATH, tile: "bg-[#229ED9]" },
};
